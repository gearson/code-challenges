...
# get_every_nth_state, get_state_abbrev, 
# get_longest_state and combine_state_names_and_abbreviations, 
# following the instructions in their docstrings.

# We hope this gives you a good feeling of how you can get data out of these 
# two data structures.

# Of course there is a lot more to it, you will come to appreciate the power
# of each data structure by continuous usage. 
